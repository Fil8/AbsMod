...
def build_continuum(x_los_c, y_los_c):
    # Load continuum:
    ...
    # determine the edges of the output cube
    # on the continuum image
    x_los_num_right = x_los_c[-1] / scale_cont_pc
    x_los_num_left = x_los_c[0] / scale_cont_pc
    y_los_num_up = y_los_c[-1] / scale_cont_pc
    y_los_num_low = y_los_c[0] / scale_cont_pc
    ...
    zoom_factor = float(len(x_los_c)) / float(len(sub_dati[0]))
